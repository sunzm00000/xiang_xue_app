...
import com.example.fishingport.app.tools.FileUtils;
...
*图片预览
* */
public class PhotoBrowserActivity extends BaseAppCompatActivity implements View.OnClickListener {
                ...
                if (imageUrls[position] != null && !"".equals(imageUrls[position])) {
                   ...
                   // view.enable();
                    ...
                    Glide.with(PhotoBrowserActivity.this).
                            ...
                            .fitCenter().crossFade().listener(new RequestListener<String, GlideDrawable>() {
                        @Override
