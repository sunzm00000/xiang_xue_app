package com.example.fishingport.app.view.circularavatar;
...
public class CircularImageView extends View {
    ...
    public void setImageBitmap(Context mContext,ArrayList<String> bitmaps) {
        ...
        for (int i = 0; i <bitmaps.size() ; i++) {
            Glide.with(mContext).load(bitmaps.get(i)).asBitmap().into(new SimpleTarget<Bitmap>() {
                @Override
