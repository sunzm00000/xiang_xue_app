...
public class NoreadAppraiselist {
    ...
    private NoreadCommentslist.StatusBean status;
    private NoreadCommentslist.ResultBean result;

    public NoreadCommentslist.StatusBean getStatus() {
        return status;
    }

    public void setStatus(NoreadCommentslist.StatusBean status) {
        this.status = status;
    }

    public NoreadCommentslist.ResultBean getResult() {
        return result;
    }

    public void setResult(NoreadCommentslist.ResultBean result) {
        this.result = result;
    }
    ...
    public static class ResultBean {
        ...
        private NoreadCommentslist.ResultBean.PageBean page;
        private List<NoreadCommentslist.ResultBean.DataBean> data;
        ...
        public NoreadCommentslist.ResultBean.PageBean getPage() {
            return page;
        }

        public void setPage(NoreadCommentslist.ResultBean.PageBean page) {
            this.page = page;
        }

        public List<NoreadCommentslist.ResultBean.DataBean> getData() {
            return data;
        }

        public void setData(List<NoreadCommentslist.ResultBean.DataBean> data) {
            this.data = data;
        }
        ...
        public static class DataBean {
            ...
            private NoreadCommentslist.ResultBean.DataBean.ResInfoBean res_info;
            ...
            public static class ResInfoBean {
                ...
                private List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.TrajectoryInfoBean> trajectory_info;
                private List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.InformationInfoBean> information_info;
                private  List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.TrainInfoBean> train_info;
                private  List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.MarketInfoBean> market_info;

                public List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.TrainInfoBean> getTrain_info() {
                    return train_info;
                }

                public void setTrain_info(List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.TrainInfoBean> train_info) {
                    this.train_info = train_info;
                }

                public List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.MarketInfoBean> getMarket_info() {
                    return market_info;
                }

                public void setMarket_info(List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.MarketInfoBean> market_info) {
                ...
                public List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.TrajectoryInfoBean> getTrajectory_info() {
                    return trajectory_info;
                }

                public void setTrajectory_info(List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.TrajectoryInfoBean> trajectory_info) {
                    this.trajectory_info = trajectory_info;
                }

                public List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.InformationInfoBean> getInformation_info() {
                    return information_info;
                }

                public void setInformation_info(List<NoreadCommentslist.ResultBean.DataBean.ResInfoBean.InformationInfoBean> information_info) {
